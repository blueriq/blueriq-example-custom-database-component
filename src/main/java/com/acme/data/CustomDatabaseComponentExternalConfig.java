...
public class CustomDatabaseComponentExternalConfig {
  ...
  public DataSource commentsSqlStoreDataSource() {
    return singleTenantDatasourceProperties.getCustomDatabaseComponent()
        .buildDataSource(CustomDatabaseComponentConfig.PROFILE_NAME);
  }
  ...
  public DataSource commentsSqlStoreMultitenantDataSource() {
    ...
    for (Map.Entry<String, DatasourceProperties> tenant : tenants.entrySet()) {
      ...
      targetDataSources.put(tenant.getKey(),
          tenantDatasource.buildDataSource(CustomDatabaseComponentConfig.PROFILE_NAME));
    }
